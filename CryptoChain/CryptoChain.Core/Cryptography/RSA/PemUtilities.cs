...
namespace CryptoChain.Core.Cryptography.RSA
{
    ...
    {
        public static RSACryptoServiceProvider FromPem(string input)
            => PemUtils.GetRSAProviderFromPem(input);
    ...
    class PemUtils
    {
        ...
        public static RSACryptoServiceProvider GetRSAProviderFromPem(string pem)
        {
